...
import { addressCreate, addressDetail, addressUpdate } from "../../lib/api/AddressApi";
...
export default function AddressEdit() {
    ...
    async function fetchAddress(e) {
        const response = await addressDetail(token, id, addressId);
        const responseBody = await response.json();
        console.log(responseBody);
        if (response.status === 200) {
            setSreet(responseBody.data.street);
                    ...
                    <div className="mb-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                value={street}
                                onChange={(e) => setSreet(e.target.value)}
                                required=""
                            />
                        </div>
                    </div>
